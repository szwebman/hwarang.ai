/**
 * Trusted Sources 관리자 프록시 (수정 / 삭제 / 단건 조회)
 *
 *   GET    /api/trusted-sources/{id}  → ${HWARANG_API_URL}/api/sources/{id}
 *   PUT    /api/trusted-sources/{id}  → ${HWARANG_API_URL}/api/sources/{id}
 *   DELETE /api/trusted-sources/{id}  → ${HWARANG_API_URL}/api/sources/{id}
 */
...
export async function GET(request: NextRequest, ctx: Ctx) {
  ...
  return forward(`${HWARANG_API_URL}/api/sources/${encodeURIComponent(id)}`, {
    method: "GET",
