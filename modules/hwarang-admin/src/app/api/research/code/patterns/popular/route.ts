 ...
 * 인기 CodePattern 프록시.
 *
 *   GET /api/research/code/patterns/popular?language=&top=
 *     → ${HWARANG_API_URL}/api/research/code/patterns/popular
 */
...
export async function GET(request: NextRequest) {
  ...
  try {
    const resp = await fetch(
      `${HWARANG_API_URL}/api/research/code/patterns/popular${search || ""}`,
      {
        method: "GET",
        headers: {
