/**
 * Research Applications 즉시 분석 트리거.
 *
 *   POST /api/research/applications/analyze
 *     → ${HWARANG_API_URL}/api/research/applications/analyze
 */
...
export async function POST(request: NextRequest) {
  ...
  try {
    const resp = await fetch(`${HWARANG_API_URL}/api/research/applications/analyze`, {
      method: "POST",
      headers: {
