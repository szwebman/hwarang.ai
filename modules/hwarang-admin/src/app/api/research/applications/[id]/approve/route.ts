/**
 * Application 승인 — 연결된 GrowthDecision 도 approved.
 *
 *   POST /api/research/applications/{id}/approve
 *     → ${HWARANG_API_URL}/api/research/applications/{id}/approve
 */
...
export async function POST(request: NextRequest, ctx: Ctx) {
  ...
  try {
    const resp = await fetch(
      `${HWARANG_API_URL}/api/research/applications/${encodeURIComponent(id)}/approve`,
      {
        method: "POST",
        headers: {
