/**
 * Application 거절 — reason 을 GrowthDecision.rejectReason 에 저장.
 *
 *   POST /api/research/applications/{id}/reject
 *     → ${HWARANG_API_URL}/api/research/applications/{id}/reject
 */
...
export async function POST(request: NextRequest, ctx: Ctx) {
  ...
  try {
    const resp = await fetch(
      `${HWARANG_API_URL}/api/research/applications/${encodeURIComponent(id)}/reject`,
      {
        method: "POST",
        headers: {
