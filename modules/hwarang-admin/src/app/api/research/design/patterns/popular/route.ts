/**
 * 인기 DesignPattern 프록시.
 *
 *   GET /api/research/design/patterns/popular?layout=&top=
 *     → ${HWARANG_API_URL}/api/research/design/patterns/popular
 */
...
export async function GET(request: NextRequest) {
  ...
  try {
    const resp = await fetch(
      `${HWARANG_API_URL}/api/research/design/patterns/popular${search || ""}`,
      {
        method: "GET",
        headers: {
