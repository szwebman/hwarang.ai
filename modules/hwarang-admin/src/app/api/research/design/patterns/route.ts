/**
 * DesignPattern 목록 프록시.
 *
 *   GET /api/research/design/patterns?layout=&trend=&applicable=&limit=
 *     → ${HWARANG_API_URL}/api/research/design/patterns
 */
...
export async function GET(request: NextRequest) {
  ...
  try {
    const resp = await fetch(
      `${HWARANG_API_URL}/api/research/design/patterns${search || ""}`,
      {
        method: "GET",
        headers: {
