...
echo
echo "다음 단계: 학습 시작"
echo "  python3 scripts/lora_train.py \\"
echo "    --base /mnt/nvme2/hwarang/models/Qwen2.5-32B-Instruct \\"
echo "    --data $COMBINED \\"
echo "    --output /mnt/nvme2/hwarang/lora_adapters/hwarang-general-v8 \\"
echo "    --lora_r 16 --lora_alpha 32 --epochs 4 --weight_decay 0.01 \\"
echo "    --batch_size 1 --grad_accum 16 --max_length 2048"
